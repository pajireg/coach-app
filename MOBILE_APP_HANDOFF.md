...
For iOS-specific implementation (tech stack, architecture, screen specs, file
layout, build & distribution), see `IOS_APP_HANDOFF.md`. This document remains
the contract for product scope and backend API behavior.
